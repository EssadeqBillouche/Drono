...
@section('css')
    <style>
        ...
        .contact-card {
            @apply bg-white rounded-lg shadow-md p-6 flex items-start border-l-4 border-primary transition-all duration-300 hover:shadow-lg;
        }

        .contact-icon {
            @apply w-10 h-10 mr-4 text-primary flex-shrink-0;
        }
        ...
        .text-input {
            @apply w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent bg-white;
        }
        ...
        .social-icon {
            @apply w-9 h-9 rounded-full flex items-center justify-center text-white transition-transform hover:scale-110;
        }
...
@section('content')
    ...
    <section class="mb-12">
        <div class="content-card">
            <h2 class="section-title accent-border">Get in Touch</h2>
    ...
    <section class="mb-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <!-- Contact Form -->
            <div class="content-card">
                <h2 class="section-title accent-border">Send Us a Message</h2>
                ...
                <form action="" method="POST" class="space-y-6">
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="message" name="message" rows="5" class="text-input" required></textarea>
                    </div>

                    <!-- File upload for business inquiries -->
                    <div class="input-group">
                        <label for="attachment" class="input-label">Attachment (Optional)</label>
            ...
            <div>
                <div class="content-card">
                    <h2 class="section-title accent-border">Find Us</h2>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div class="flex space-x-3">
                            <a href="#" class="social-icon bg-[#1877F2]"> <!-- Facebook blue -->
                            ...
                            <a href="#" class="social-icon bg-[#1DA1F2]"> <!-- Twitter blue -->
                            ...
                            <a href="#" class="social-icon bg-[#E4405F]"> <!-- Instagram pink/purple -->
                            ...
                            <a href="#" class="social-icon bg-[#0A66C2]"> <!-- LinkedIn blue -->
                            ...
                            <a href="#" class="social-icon bg-[#FF0000]"> <!-- YouTube red -->
    ...
    <section class="mb-12">
        <div class="content-card">
            <h2 class="section-title accent-border">Frequently Asked Questions</h2>
