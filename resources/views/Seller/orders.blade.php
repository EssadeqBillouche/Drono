...
```html file="resources/views/seller/analytics.blade.php"
@extends('layouts.seller-dashboard')
...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="h-80 bg-gray-50 rounded-lg flex items-center justify-center">
                <p class="text-gray-500">Product revenue chart will be displayed here</p>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="h-80 bg-gray-50 rounded-lg flex items-center justify-center">
                <p class="text-gray-500">Demographics chart will be displayed here</p>
            </div>
        </div>
